...
import id.ac.umn.test.databinding.ActivityWeeklyViewBinding;
...
public class WeeklyView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityWeeklyViewBinding.inflate(getLayoutInflater());
...
//        isiDaftarMusik();
        ...
        mAdapter = new WeeklyAdapter(this, daftarMusik);
...
//
//        daftarMusik.add(new SourcePlanner("Rapat BPH Koor", "Rapat", "fire", "android.resource://" +getPackageName() + "/"+ R.raw.wowsfx));
