...
public class SourcePlanner {
    ...
    public SourcePlanner(int id, String judul, String deskripsi, String time, LocalDate date){
        this.id = id;
        this.judul = judul;
    ...
    public SourcePlanner(int id, String judul, String deskripsi, String time){
        this.id = id;
        this.judul = judul;
        this.deskripsi = deskripsi;
        this.time = time;
